...
/* 
check Auth.vue for the usage of this plugins
...
export default {
  install(app) {
    // 'app' reference for Vue Application
    // 'options' argument is additional data passed from Vue instance to the plugin
