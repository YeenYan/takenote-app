  ...
  <modal-wrapper>
    <vee-form class="noteList__wrapper" @submit="save">
      <div class="top-color" :class="colorActive">
        ...
        <span class="material-symbols-outlined" @click.prevent="closeAll"> close </span>
      </div>
      ...
      <div class="btnStyling__wrapper">
        <button @click="applyEdit('bold')">
          <span class="material-symbols-outlined"> format_bold </span>
        </button>
        <button @click="applyEdit('italic')">
          <span class="material-symbols-outlined"> format_italic </span>
        </button>
        <button @click="applyEdit('underline')">
          <span class="material-symbols-outlined"> format_underlined </span>
        </button>
        <button @click="applyEdit('strikethrough')">
